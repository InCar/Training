...
本指南将带领你理解GitHub中最为基础的五项要素：**Repositories**，**Branches**，**Commits**，**Issues**及**Pull Requests**。

当你理解了GitHub的五项基本要素后，你将可以学得更多的东西，在GitHub上走的更远。 同时，在此`hello-world`知识库(如：[holman/feedback](https://github.com/holman/ama),将来的资料库：[jlord/hello-world](https://github.com/jlord/hello-world))，你可以存储此项目相关的想法、资源、笔记及讨论或者其他相关的事情。
