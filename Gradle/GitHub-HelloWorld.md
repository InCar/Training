...
拉取请求是GitHub协同工作的核心。当你创建一个**拉取请求**，表示你提供你的修改并请求某人去拉取你的贡献--也就是将这些修改合并到它们的分支。GitHub的消息推送功能允许你比较两个分支上的内容。这些修改、增加、删除的内容会以绿色、红色以及所谓的**差异**的形式显示。
...
你可以谦虚的吹牛了，这些是你在本指南中学到的东西：创建一个版本库、 分支, 问题和拉取请求, 然后合并拉取请求！炫耀一下你的[贡献广场](https://help.github.com/articles/viewing-contributions) 。
